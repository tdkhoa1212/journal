...
def parse_opt(known=False):
    ...
    parser.add_argument('--input_shape',     type=int,   default=250604,        help='shape of 1-D input data of PU dataset')
    ...
    parser.add_argument('--data_dir',                 type=str,     default='/content/drive/MyDrive/Khoa/PU_data/',        help='direction of data')
